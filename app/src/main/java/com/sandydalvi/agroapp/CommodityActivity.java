...
public class CommodityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommodityActivity.this.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView1);
        goiDetails = new ArrayList<>();
        linearLayoutManager = new LinearLayoutManager(this);
        goiAdapter = new GoiAdapter(CommodityActivity.this, goiDetails);
        ...
        getSupportActionBar().setTitle("Agro App");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent filterActivity=new Intent(CommodityActivity.this,FilterActivity.class);
